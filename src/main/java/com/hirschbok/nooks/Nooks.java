...
public class Nooks
{
    ...
    public static final String MOD_ID = "nooks";
    ...
    public static final ItemGroup TAB = new ItemGroup("nooksTab") {

        @Override
        public ItemStack createIcon() {
            return new ItemStack(RegistryHandler.METAL_DETECTOR.get());
        }
    };
}
